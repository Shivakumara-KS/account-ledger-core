...
public record Money(CurrencyCode currency, BigDecimal amount) {
    ...
    public static Money of(CurrencyCode c, String value) { return new Money(c, new BigDecimal(value)); }
    public static Money of(CurrencyCode c, BigDecimal value) { return new Money(c, value); }
    public Money add(Money other) { check(other); return new Money(currency, amount.add(other.amount)); }
    public Money subtract(Money other) { check(other); return new Money(currency, amount.subtract(other.amount)); }
    public Money negate() { return new Money(currency, amount.negate()); }
